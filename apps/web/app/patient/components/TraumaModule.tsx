...
import { TraumaSessionState } from '@paracompanion/clinical';
import { Activity, Save } from 'lucide-react';
import { useClinicalSessionStore } from '../../../store/clinical';

export function TraumaModule() {
      ...
      <div className="md:col-span-8 space-y-6">
        <div className="bg-surface-container-lowest p-6 rounded shadow-sm border border-outline-variant/10">
          <h2 className="text-2xl font-bold font-headline text-on-surface mb-6 flex items-center gap-2">
            <Activity className="text-primary" /> Major Trauma (ATMISTER)
          </h2>
          <div className="text-outline italic">
            Web interface for Trauma is currently a simplified stub for testing. Please use the mobile app for full ATMISTER timeline capture.
          </div>
        </div>
      </div>
